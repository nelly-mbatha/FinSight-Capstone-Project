...
- **CRISP-DM Alignment:** Structured end-to-end framework flowing sequentially from Business Understanding, Data Cleaning, and Data Profiling (EDA) to robust Time-Series Modeling, Probability Calibration, and Latency Testing.
...
- **Probability Accuracy:** Incorporates a Platt-scaling sigmoid calibration layer to ensure model output probabilities correspond strictly to empirical win frequencies (Brier Score minimization) for real-world risk management.
...
- **Classification Quality:** Reached a Holdout AUROC of **0.6107**, significantly outperforming the 0.50 random-walk market baseline, confirming a genuine mathematical edge in a highly volatile market.
